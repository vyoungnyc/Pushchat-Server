 ...
 */
	Configure::write('Security.salt', 'gSAD%$UJMHgbw4tsgdhn9j03tmsdv20fzsG$YUI*bdfgwe102hz');
/**
 ...
 */
      ...
      Cache::config('messages', array(
              'engine' => 'Memcache', //[required]
              'duration'=> 3600, //[optional]
              'servers' => array('192.168.134.109:11212'), //[optional]
              'prefix' => 'messages_',
      ));
